    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      <div class="bg-white dark:bg-blue-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10">
        <Form @submit="onSubmit" :validation-schema="schema" class="space-y-6">
          ...
          <div>
            <label for="password" class="block text-sm font-medium text-gray-700 dark:text-white">{{ $t('Password') }}</label>
            <div class="mt-1">
              <text-input
                class="appearance-none block w-full px-3 py-2 border dark:bg-blue-gray-900 border-gray-300 dark:border-gray-600 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                name="password"
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              ...
              />
              <label for="remember-me" class="ml-2 block text-sm text-gray-700 dark:text-white">{{ $t('RememberMe') }}</label>
            </div>
        ...
        <div class="mt-6">
          <div class="relative">
            ...
            <div class="relative flex justify-center text-sm">
              <span class="px-2 bg-white dark:bg-blue-gray-800 text-gray-500 dark:text-white">{{ $t('OrContinueWith') }}</span>
            </div>
          </div>
